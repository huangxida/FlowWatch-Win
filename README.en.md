...
- **System tray** — Right-click menu for quick access to Settings, Statistics, App Traffic, Lock/Auto Hide, and Exit
- **Lock on Top** — Pin the overlay on top with click-through; unlock to drag and reposition
- **Auto Hide** — Overlay fades to 10% opacity when the mouse leaves and returns to full opacity on hover; works together with Lock on Top
...
└── FlowWatch/
    ...
    │   ├── UpdateService          # In-app auto-update (GitHub Releases)
    ...
    │   └── UpdateWindow           # Version update UI
    ├── Models/                    # Data models
...
| AutoHide | false | Auto-hide overlay (fades on mouse leave, restores on hover) |
...
| AutoCheckUpdate | true | Auto-check for updates (24-hour interval) |
